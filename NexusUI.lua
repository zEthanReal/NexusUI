...
function NexusUI:CreateWindow(cfg)
    ...
    -- Title
    New("TextLabel", {
        Size = UDim2.new(1,-110, 0, subtitle and 18 or 20),
        Position = subtitle and UDim2.new(0,28,0,8) or UDim2.new(0,28,0.5,-10),
    ...
    if subtitle then
        New("TextLabel", {
            Size = UDim2.new(1,-110,0,14), Position = UDim2.new(0,28,0,28),
    ...
    -- Control buttons
    local function CtrlBtn(rightOff, bg, sym, z)
        local b = New("TextButton", {
            Size             = UDim2.new(0, 26, 0, 26),
            Position         = UDim2.new(1, rightOff, 0.5, -13),
            BackgroundColor3 = bg,
            BorderSizePixel  = 0,
            Text             = sym,
    ...
    local CloseBtn = CtrlBtn(-10,  Color3.fromRGB(255, 74, 74), "✕")
    local MinBtn   = CtrlBtn(-42,  T.SurfaceAlt,                "─")
    for _, b in ipairs({CloseBtn, MinBtn}) do
        b.MouseEnter:Connect(function() Tween(b,{BackgroundTransparency=0.2},0.12) end)
